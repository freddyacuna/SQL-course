...
--(3) Se pide que muestre las dos nacionalidades de los usuarios que tienen mayor representatividad en la plataforma, sin considerar Brasil ni Argentina. Para esto genere una lista que contenga la nacionalidad junto con su porcentaje de representatividad en relación al total.
...
--(4) Muestre la cantidad de años de experiencia promedio de los productores que hayan hecho películas asociadas a Premium Access, generando una lista con el nombre del contenido junto a su cantidad de años de experiencia promedio.
...
--(5) Se le solicita que muestre la cantidad de usuarios que han visto contenidos entre el 20 de diciembre de 2020 y el 31 de marzo de 2021, mostrando el nombre de cada contenido junto a su respectiva cantidad de espectadores.
...
--(6) La gerencia quiere experimentar si es posible aumentar la fidelidad de los usuarios si, en el día de su cumpleaños, se incluye un saludo personalizado dentro de algún contenido que estén viendo en vivo. Debido a esto, se pide que genere una lista con los usuarios (si es que hay) que vieron algún contenido el día de su cumpleaños, con el nombre del usuario y el contenido visto.
...
--(7) Se requiere saber cuánto es el salario promedio por género de desarrolladores, pero solo de los lenguajes de programación utilizados por ambos géneros, los cuales deben ser mencionados. 
...
--(8) Se requiere saber el nombre de cada director principal que haya trabajado en los tres contenidos más vistos entre marzo y abril. Para esto genere una lista con el nombre de dichos directores principales en orden alfabético, junto con los nombres de dichos contenidos.
...
--(9) Una madre de familia quiere solicitar una devolución, ya que no sabía que un mismo plan servía para toda la familia, por lo que compró uno mensual para ella y un anual para cada una de sus dos hijas. Si, además de eso, su hija menor le pidió comprar el Premium Access de “Raya y el Último Dragón”, ¿Cuánto gastó la madre? Genere una consulta que muestre el monto neto, el IVA y el monto total en pesos chilenos.
...
--(10) Para ver si el modelo de negocios está siendo rentable en esta primera etapa (y pensar si invertir más o retirarse) es necesario conocer las utilidades que se están generando y compararlas con lo presupuestado, al menos para el período actual. Para esto considere que los ingresos reales corresponden al monto generado por la venta de planes y programas de Premium Access (aproximadamente la mitad de usuarios paga el promedio de los precios de Premium Access) y, el costo como el desembolso por sueldos de ingenieros (considerando 6 meses) y compra de implementos. Muestre todos estos valores: costos netos, ingresos netos y utilidades netas (real y presupuestada), en pesos chilenos.
HINT: Considere que el ingreso presupuestado corresponde a la venta de un plan anual + un contenido con premium access promedio por usuario, y que los costos presupuestados son iguales a los reales.
...
--(11) Por necesidades de un modelo cuantitativo de un analista, a usted se le pide mostrar el nombre de aquellos actores cuyo representante tenga requerimientos adicionales, que trabaje con más de seis actores registrados en nuestra plataforma, y que la cantidad de premios importantes que tienen sus actores en total sea más de 10. Además, debe presentar dos columnas que indiquen si el actor estuvo en películas lanzadas en 2020 y 2021 indicando con un Sí o No su presencia en cada año.
...
--(12) Para un estudio de mercado, se requiere conocer la proporción de tipos de dispositivos utilizados por hombres y mujeres al ver contenidos sugeridos por el algoritmo más reciente durante lo que va del año. Muestre las proporciones distinguiendo por tipo de dispositivo y por hombres/mujeres.
...
--(14) Para beneficiar a los ingenieros de mayor edad, se aumentará el sueldo de aquellos que sean adultos mayores (60 años o más). Si se trata de ingenieros desarrolladores, se aumentará en $100.000 CLP su remuneración, mientras que a los analistas se les dará un aumento de $120.000 CLP. Realice las modificaciones pertinentes en una sola consulta.
...
--(15)
/*
Tras una primera buena impresión, la organización ha decidido agregar tres nuevos servidores en tierras sudamericanas. Se le pide que ingrese la siguiente información a las tablas correspondientes:
...
--(16) Se le pide que agregue a la tabla PELÍCULA un atributo que indique si esa película está siendo tendencia o no, es decir, si la película está dentro de las 10 más visualizadas de la plataforma. El atributo debe llamarse “Es Tendencia” y obtener el valor 1 si corresponde a este tipo de películas y el valor 0 si no. 
